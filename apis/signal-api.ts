...
export const SignalApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        throwSignal: async (body?: SignalDto, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SignalApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async throwSignal(body?: SignalDto, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await SignalApiAxiosParamCreator(configuration).throwSignal(body, options);
...
export const SignalApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async throwSignal(body?: SignalDto, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return SignalApiFp(configuration).throwSignal(body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SignalApi extends BaseAPI {
     ...
     * @memberof SignalApi
     */
    public async throwSignal(body?: SignalDto, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return SignalApiFp(this.configuration).throwSignal(body, options).then((request) => request(this.axios, this.basePath));
    }
}
